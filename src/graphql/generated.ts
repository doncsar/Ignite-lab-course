...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', videoId: string, title: string, description: string, teacher?: { __typename?: 'Teacher', avatarURL: string, bio: string, name: string } | null } | null };
